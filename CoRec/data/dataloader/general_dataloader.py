...
from CoRec.data.dataloader.abstract_dataloader import (
    AbstractDataLoader,
    NegSampleDataLoader,
)
from CoRec.data.interaction import Interaction, cat_interactions
from CoRec.utils import InputType, ModelType
