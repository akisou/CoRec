...
from CoRec.data.dataloader import *
from CoRec.sampler import KGSampler, Sampler, RepeatableSampler
from CoRec.utils import ModelType, ensure_dir, get_local_time, set_color
from CoRec.utils.argument_list import dataset_arguments
...
def create_dataset(config):
    ...
    """
    dataset_module = importlib.import_module("CoRec.data.dataset")
